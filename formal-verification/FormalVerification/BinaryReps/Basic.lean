...
import FormalVerification.Keccak.SemanticEquivalence -- TODO Remove the import and extract helpers module
...
@[simp]
theorem gates_is_bit_one_sub {a : F}: is_bit (Gates.sub 1 a) ↔ is_bit a := by
